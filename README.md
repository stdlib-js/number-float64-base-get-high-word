...
```javascript
getHighWord = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-get-high-word@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-get-high-word@v0.2.0-umd/browser.js"></script>
```
